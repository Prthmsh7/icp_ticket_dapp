...
import { idlFactory } from './icp_ticket_dapp_frontend.did.js';
export { idlFactory } from './icp_ticket_dapp_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_TICKET_DAPP_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_ticket_dapp_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_ticket_dapp_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_ticket_dapp_frontend.did.js")._SERVICE>}
 */
export const icp_ticket_dapp_frontend = createActor(canisterId);
