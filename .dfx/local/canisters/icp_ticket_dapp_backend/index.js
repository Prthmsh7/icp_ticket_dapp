...
import { idlFactory } from './icp_ticket_dapp_backend.did.js';
export { idlFactory } from './icp_ticket_dapp_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_TICKET_DAPP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_ticket_dapp_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_ticket_dapp_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_ticket_dapp_backend.did.js")._SERVICE>}
 */
export const icp_ticket_dapp_backend = createActor(canisterId);
